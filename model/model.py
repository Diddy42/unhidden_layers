...
usage for extraction: python model.py extract img_filename
es. python model.py extract elephant.jpg

extraction: it extracts 3 images for each significant layer, and saves them in a directory
